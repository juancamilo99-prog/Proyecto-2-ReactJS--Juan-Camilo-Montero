...
function RankinCard({ anime, rank, isFavorite, onToggleFavorite, onClick }) {
    ...
    >
      <div className="aspect-4/5 relative overflow-hidden bg-[#1e1a2e]">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent">
          ...
          {/* Favorite button */}
          <button className={`absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 p-1.5 rounded-full bg-black/50 transition-all ${isFavorite ? 'text-[#e91e8c]' : 'text-[#8b7aa8] hover:text-[#e91e8c]'}`}
